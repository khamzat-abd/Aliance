<section class="section section-light">
  <div class="container">
    ...
    <div class="swiper swiper_second">
      ...
      <div class="slids-buttons primary-buttons-wrapper">
        <div class="slids-button-prev primary-button-prev">
          <svg width="36" height=" 24">
            <use href="img/sprite.svg#arrow-prev"></use>
          </svg>
        </div>
        <div class="slids-button-next primary-button-next">
          <svg width="36" height=" 24">

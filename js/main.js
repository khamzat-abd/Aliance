...
const mySwiper = new Swiper(".swiper_second", {
  speed: 400,
  height: true,
  slidesPerView: 1,
  navigation: {
    nextEl: ".slids-button-next",
    prevEl: ".slids-button-prev",
  },
  breakpoints: {
    // when window width is >= 576px
    576: {
...
const swiperBlog = new Swiper(".swiper_three", {
  speed: 400,
  slidesPerView: 1,
  spaceBetween: 30,
  navigation: {
...
let alertModal =
  document.querySelector("#alert-modal"); /* окно о блогодарности */

const modalButtons = document.querySelectorAll(
  "[data-toggle=modal]"
); /* переключатели модальных окон */
modalButtons.forEach((button) => {
  /* клик пл переключателю */
